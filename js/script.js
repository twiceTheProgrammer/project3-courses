...
$(document).ready(function(){
   ...
   for (index ; index < courses.length ; index++){
     $('#course').prepend(<div class="col-xm-6">
                            <div class="card mr-4 text-center" style="width : 350px;">
                               <img src="courses[index].image" height="250px">
                               <h3 class="card"> courses[index].title </h3>
